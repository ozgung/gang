...
public class ImageRenderer
{
     ...
     * @throws SAXException
     */
    public boolean renderStream(InputStream in, OutputStream out, Type type) throws IOException, SAXException
    {


        //Open the network connection
        StreamDocumentSource docSource = new StreamDocumentSource(in, new java.net.URL("http://ganghq.com"), "text/html");
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            //r.renderStream((InputStream) args[0], os, type);
